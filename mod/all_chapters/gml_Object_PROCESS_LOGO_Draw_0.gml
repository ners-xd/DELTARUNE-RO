...
if (draw_screen)
{
    if (PHASE == 0)
    {
        ...
        for (i = 0; i < h; i += 1)
        {
            ...
            draw_sprite_part_ext(IMAGE_LOGO_CENTER_CHAPTERNUMBER, 0, 0, i, w, 2, 88.5 + xoff, y + i + 41, 1, 1, c_white, (1 - factor) / 2);
            draw_sprite_part_ext(IMAGE_LOGO_CENTER_CHAPTERNUMBER, 0, 0, i, w, 2, 88.5 + xoff2, y + i + 41, 1, 1, c_white, (1 - factor) / 2);
            draw_sprite_part_ext(IMAGE_LOGO_CENTER_CHAPTERNUMBER, 0, 0, i, w, 2, 88.5 + xoff3, y + i + 41, 1, 1, c_white, (1 - factor) / 2);
        }
    }
    ...
    {
        draw_self();
        draw_sprite(IMAGE_LOGO_CENTER_CHAPTERNUMBER, 0, 153.5, y + 50);
        PHASETIMER += 1;
    ...
    if (PHASE == 2)
    {
        ...
        draw_sprite_ext(IMAGE_LOGO_CENTER_CHAPTERNUMBER, 0, 153.5, y + 50, image_xscale, image_yscale, 0, c_white, AB);
        mina = siner / 30;
        ...
        for (i = 0; i < 10; i += 1)
        {
            ...
            draw_sprite_ext(IMAGE_LOGO_CENTER, image_index, (x + (w / 2)) - (sin((siner / 8) + (i / 2)) * (i * factor2)), y + (h / 2) + (cos((siner / 8) + (i / 2)) * (i * factor2)), image_xscale, image_yscale, 0, c_white, mina * AA);
            draw_sprite_ext(IMAGE_LOGO_CENTER, image_index, x + (w / 2) + (sin((siner / 8) + (i / 2)) * (i * factor2)), y + (h / 2) + (cos((siner / 8) + (i / 2)) * (i * factor2)), image_xscale, image_yscale, 0, c_white, mina * AA);
            draw_sprite_ext(IMAGE_LOGO_CENTER_CHAPTERNUMBER, 0, (x + (w / 2)) - (sin((siner / 8) + (i / 2)) * i * factor2) - 6.5, (33 + y + (h / 2)) - (cos((siner / 8) + (i / 2)) * (i * factor2)), image_xscale, image_yscale, 0, c_white, mina * AA);
            draw_sprite_ext(IMAGE_LOGO_CENTER_CHAPTERNUMBER, 0, (x + (w / 2) + (sin((siner / 8) + (i / 2)) * i * factor2)) - 6.5, (33 + y + (h / 2)) - (cos((siner / 8) + (i / 2)) * (i * factor2)), image_xscale, image_yscale, 0, c_white, mina * AA);
            draw_sprite_ext(IMAGE_LOGO_CENTER_CHAPTERNUMBER, 0, (x + (w / 2)) - (sin((siner / 8) + (i / 2)) * i * factor2) - 6.5, 33 + y + (h / 2) + (cos((siner / 8) + (i / 2)) * (i * factor2)), image_xscale, image_yscale, 0, c_white, mina * AA);
            draw_sprite_ext(IMAGE_LOGO_CENTER_CHAPTERNUMBER, 0, (x + (w / 2) + (sin((siner / 8) + (i / 2)) * i * factor2)) - 6.5, 33 + y + (h / 2) + (cos((siner / 8) + (i / 2)) * (i * factor2)), image_xscale, image_yscale, 0, c_white, mina * AA);
        }
